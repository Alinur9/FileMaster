...
public class FileMaster extends Application {
  ...
  public void start(Stage stage) throws Exception {
    ...
    final String[] finalPath = new String[1]; // for generating new files
    String[] cPath1arr = new String[1]; // comparison folder 1
    String[] cPath2arr = new String[1]; // comparison folder 2
    ...
    VBox vBox = new VBox(imageView, line2, startLbl, line3, fileCountLbl, setFileCount, sizeMbLbl,
        setMbSize, nameLbl, setName, pathLbl, gPathButton
        , generateLbl, generateButton, line, dividerLbl, line1, pathLbl1, cPathButton1, pathLbl2,
        cPathButton2, confirmationLbl
        , compareButton);
    vBox.setSpacing(7);
  ...
  private void compareHandle(String cPath1, String cPath2, Alert cSuccessAlert,
      Alert cFailureAlert) {
    try {
